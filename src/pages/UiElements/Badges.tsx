...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Marco Nina Nuñez Author - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Marco Nina Nuñez Author - React.js Tailwind CSS Admin Dashboard Template"
      />
