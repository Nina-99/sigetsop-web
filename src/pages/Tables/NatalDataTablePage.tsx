...
export default function NatalDataPage() {
  ...
  return (
    <>
      <PageMeta
        title="Sigetsop - Natalidad y Lactancia"
        description="Página de gestión de natalidad y lactancia"
      />
      <PageBreadCrumb pageTitle="Natalidad y Lactancia" />
      <div className="space-y-6">
        {!selectedPersonnelId ? (
          ...
          <ComponentCard title={`Natalidad y Lactancia - ${personnelName}`}>
            <div className="flex flex-col gap-4">
              ...
              <NatalDataTable personnelId={selectedPersonnelId} />
            </div>
          </ComponentCard>
        )}
      </div>
